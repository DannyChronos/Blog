    ...
    <div class="register-photo">
        <div id="subscribe" class="form-container" style="width: 90%;">
            ...
            <form method="post" action="">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="font-weight: bold;" name="btn">Sign Up</button></div><a class="already" href="/login"style="font-family: Amaranth, sans-serif;font-weight: bold;">You already have an account? Login here.</a>
            </form>
        </div>
    </div>
